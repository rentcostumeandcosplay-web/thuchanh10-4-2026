    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.profileHeader}>
          <Image source={require('../assets/Solid_Snake.png')} style={styles.avatar} />
          <View style={styles.profileText}>
            <View style={styles.nameRow}>
              <Text style={styles.name}>Solid Snake</Text>
              <Feather name="edit-2" size={16} color="#53B175" style={{marginLeft: 10}} />
            </View>
            <Text style={styles.email}>SolidSnake@gmail.com</Text>
          </View>
        </View>
